      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[1, 2, 3].map((n) => (
            <article
              key={n}
              className="bg-slate-800/50 rounded-lg p-4 border border-slate-700 hover:shadow-lg transition-shadow"
            >
              ...
              <div className="mt-3 flex items-center justify-between">
                <span className="badge bg-rose-500 text-black">
                  COMING SOON
                </span>
